...
namespace masc {
	...
	public:
		...
		void DebugTokens();
		Token &operator[](size_t pos) {  if(pos < tok_vec.size()) return tok_vec[pos]; else return cur; }
		bool LexAnayalize();
	...
	static const char *tok_array[] = {"insert", "master","uses","mas","var","begin","end","mov","add","sub","mul","div","or","xor","and","not", "push", "pop","inc","dec","cmp","jmp","jne","je","jl","jg","jle","jge","ret","exit","call","scat","print","proc","implement","extern","var&","var$","var#", 0, 0 };
	...
	public:
		...
		inline bool Bounds(size_t pos) { if(pos < p->tok_vec.size()) return true; return false; }
